...
- **Built-in Utilities** — Includes various utilities for first-launch login confirmation, plugin extension sync, and more
...
- **Directory override** — Custom config directory (Dropbox, OneDrive, iCloud, NAS)
