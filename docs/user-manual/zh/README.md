...
- 文档版本：v3.16.0
- 最后更新：2026-05-29
- 适用于 CC Gateway v3.16.0+

### v3.16.0 亮点

- **Codex Chat Completions 路由**：DeepSeek、Kimi、GLM、MiniMax 等仅支持 Chat 协议的供应商可通过 Codex 使用 — 详见 [2.1 添加供应商](./2-providers/2.1-add.md)
- **托管 CLI 工具生命周期**：在设置 / 关于页安装、升级、全部升级并诊断 Claude / Codex / Grok Build / Hermes — 详见 [1.5 个性化配置](./1-getting-started/1.5-settings.md)
...
- **配额与余额展示**：官方订阅类（Claude/Codex/Grok Build/Copilot/Codex OAuth）自动展示剩余额度；Token Plan 和第三方余额通过内置模板一键启用 — 详见 [2.5 用量查询](./2-providers/2.5-usage-query.md)
- **Codex OAuth 反向代理**：用 ChatGPT 账号在 Claude Code 中复用 Codex 服务 — 详见 [2.1 添加供应商](./2-providers/2.1-add.md)
- **托盘按应用分级菜单**：Claude / Codex / Grok Build 独立子菜单，标题展示当前供应商与可用用量摘要 — 详见 [2.2 切换供应商](./2-providers/2.2-switch.md)
...
- **OpenCode / OpenClaw / Hermes 流式检测覆盖**：Stream Check 面板覆盖 Claude / Codex / Grok Build / Hermes — 详见 [4.5 模型检查](./4-proxy/4.5-model-test.md)
