...
> **Retired**: This maintenance build no longer ships Session Manager. The rest of this page is historical.
...
| Grok Build | Grok Build session directory |
...
> **Note**: The Session Manager covers the session sources listed above; the Claude Desktop entry reuses the Claude Code session view.
...
**On macOS:**
- CC Gateway launches your preferred terminal with the resume command
...
3. CC Gateway launches the Claude terminal session in the selected directory
