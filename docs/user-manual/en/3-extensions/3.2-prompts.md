...
CC Gateway provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
ccgateway://import/prompt?data=<base64-encoded preset>
```
