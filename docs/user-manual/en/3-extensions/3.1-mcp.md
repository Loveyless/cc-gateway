...
> **Note**: OpenClaw and Claude Desktop do not currently support CC Gateway MCP sync. MCP functionality is supported for Claude, Codex, Gemini, OpenCode, and Hermes.
