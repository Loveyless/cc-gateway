...
2. CC Gateway updates the configuration file
...
1. Right-click the CC Gateway icon in the system tray
...
- **Submenu title shows the currently active provider and usage summary**: You know at a glance which provider Claude / Codex / Grok Build is using, plus available cached usage information, without opening the submenu
...
When switching providers, CC Gateway modifies the following files:
