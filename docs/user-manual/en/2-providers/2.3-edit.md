...
CC Gateway provides rich icon customization features:
...
This ensures CC Gateway and CLI tool configurations stay in sync.
...
When adding a provider, CC Gateway automatically extracts endpoint URLs from the configuration.
