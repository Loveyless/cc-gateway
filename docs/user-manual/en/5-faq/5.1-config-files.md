...
> **Retired**: This maintenance build no longer reads or writes `~/.hermes`. `hermesConfigDir` remains only as a historical settings field. The rest of this section is historical.
