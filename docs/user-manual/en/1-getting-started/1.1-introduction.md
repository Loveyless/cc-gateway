...
CC Gateway is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, and **Grok Build**.
...
- **Scattered configurations**: Claude Code, Claude Desktop, Codex, and Grok Build each have independent configuration files in different formats
- **No usage monitoring**: No visibility into how many API calls were made or how much they cost

CC Gateway solves these problems through a unified interface.
...
- **Skills**: Import local skills, toggle per app, and project them into app directories
...
CC Gateway is built with a modern technology stack:
