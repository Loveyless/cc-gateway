...
CC Gateway is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, and **Hermes**.
...
- **Scattered configurations**: Claude Code, Claude Desktop, Codex, Grok Build, and Hermes each have independent configuration files in different formats
