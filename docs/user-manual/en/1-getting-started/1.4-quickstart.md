...
- Right-click the CC Gateway icon in the system tray
...
| Grok Build | Requires closing and reopening the terminal |
| Hermes | Requires closing and reopening the terminal |

### Claude Code First Launch Prompt

If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in CC Gateway:

1. Open CC Gateway "Settings > General"
