...
| 4 | App Switcher | Switch between Claude / Claude Desktop / Codex / Grok Build / Hermes |
...
|--------|----------|------------|
| Skills | Skill extension management | Claude / Codex / Grok Build / Hermes |
| Prompts | System prompt management | Claude / Codex / Grok Build / Hermes |
| MCP | MCP server management | Claude / Codex / Grok Build / Hermes |
...
CC Gateway displays an icon in the system tray, providing quick access to operations.
...
| App Submenus | Collapsible submenus grouped by Claude/Codex/Grok Build (e.g., "Claude · PackyCode"), with current provider and cached usage summaries when available |
