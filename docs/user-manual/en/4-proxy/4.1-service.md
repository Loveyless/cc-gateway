...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CC Gateway)
...
After starting the proxy and enabling app takeover, CC Gateway modifies app configurations:
...
When stopping the proxy, CC Gateway will:
