...
const TOOL_NAMES = ["claude", "codex", "grok"] as const;
    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/Loveyless/cc-gateway/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/Loveyless/cc-gateway/releases/tag/${displayVersion}`,
      );
    } catch (error) {
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/Loveyless/cc-gateway",
                )
              }
